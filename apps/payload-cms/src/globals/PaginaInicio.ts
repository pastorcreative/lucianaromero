  ...
  fields: [
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'imagenGaleria',     label: 'Imagen Galería',       type: 'upload', relationTo: 'media' },
        ...
        { name: 'imagenComercial',   label: 'Imagen Comercial',     type: 'upload', relationTo: 'media' },
        ...
        { name: 'imagenNovias',      label: 'Imagen Novias',        type: 'upload', relationTo: 'media' },
        ...
        { name: 'imagenCursos',      label: 'Imagen Cursos',        type: 'upload', relationTo: 'media' },
      ],
    },
